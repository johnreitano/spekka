...
- The Skill.md contains a link that points to `spekka/standards/...` — Follow that link and read its contents.
...
Skip this step if SKIP_FINAL_OUTPUT=true.
...
After all skills have been improved:

1. Output this exact line to signal completion:
   ```
   ✅ SKILL_IMPROVEMENT_COMPLETE
   ```

2. If SKIP_FINAL_OUTPUT=true was specified:
   - Do NOT display the Step 5 advisory message
   - Do NOT wait for user input
   - The calling workflow will continue after seeing the completion signal
